...
Each dataset notebook runs all four flavors (torch/split, torch/mixed, jax/split,
keras/split) for a small epoch and seed budget so the scaffold executes quickly.
