...
def test_absolute_default_weight_scale_and_bias() -> None:
    in_f, units = 256, 512
    layer = _build(units, in_f, mode="mixed", activation="elu")
...
def test_absolute_bias_nonzero_off_half() -> None:
    layer = _build(64, 64, mode="mixed", activation="elu", convex_fraction=0.25)
...
def test_switch_default_unchanged() -> None:
    layer = _build(64, 64, mode="split", activation="elu")
